...
{
gotoxy(18,37);
printf("%c[1;%dm",27,color-10);
printf("*~~~~~~~~~~~~~~~~~~@~~~~~~~~~~~~~~#~~~~~~~~~~~~@~~~~~~~~~~~~~~~~~~*");
fflush(stdout);
printf("%c[0m",27);
gotoxy(20,37);
printf("%c[1;37;%dm",27,color-5);
printf("Kunal's Games Production(KGP) welcomes you to Kunal World of Games.");
fflush(stdout);
printf("%c[0m",27);
gotoxy(22,37);
printf("%c[1;%dm",27,color-10);
